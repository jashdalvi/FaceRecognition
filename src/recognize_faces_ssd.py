...
prototxtPath = os.path.join("..",os.path.join(args["face"], "deploy.prototxt"))
weightsPath = os.path.join("..",os.path.join(args["face"],"res10_300x300_ssd_iter_140000.caffemodel"))
